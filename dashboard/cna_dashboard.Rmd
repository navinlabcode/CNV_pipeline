...
} else umap_n_neighbors <- 15

dat_umap <- umap::umap(dat_seg_t, 
                       random_state= 42, 
                       metric = "manhattan",
...
cl <- dbscan::sNNclust(umap_df, k = snn_k_param, eps = .5, minPts = 5)
...
# setting colors
row_col <- setNames(colorRampPalette(paletteer_d(ggsci, 
                                nrc_npg, 10))(n_colors),
