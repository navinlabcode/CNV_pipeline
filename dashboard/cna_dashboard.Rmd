...
ratios_data_l_gat <- tidyr::gather(data = ratios_data %>% dplyr::select(1:50, abspos), key = "cell", value = "ratios_rat", -abspos)
long_seg_t_gat <- tidyr::gather(data = dat_seg_cp %>% dplyr::select(1:50, abspos), key = "cell", value = "seg_mean", -abspos)
