...
Cells=rep("PM2055",nrow(dat_seg_order))
#Cells=rep("Peak_D",nrow(dat_seg_order))
Cells[grep(rownames(dat_seg_order),pattern = "_2_",ignore.case = T)]="PM2199"
#Cells[grep(rownames(dat_seg_order),pattern = "Parental_P1_",ignore.case = T)]="Parental_1"
#Cells[grep(rownames(dat_seg_order),pattern = "Parental_2_",ignore.case = T)]="Parental_2"
#Cells[grep(rownames(dat_seg_order),pattern = "Parental_3_",ignore.case = T)]="Parental_3"
#col<-c("blue","orange","green","purple")
col<-c("#C20088FF","#0075DCFF")
#names(col)<-c("Organoids", "Patient")
names(col)<-c("PM2055", "PM2199")
heat_row_col <- rowAnnotation(
	     df = as.data.frame(clusters = sort(cl$cluster)),
...
draw(heat_row_col+ht,heatmap_legend_side = "right")
```
...
### 31-32
```{r fig.width=10,fig.height=5}
knitr::include_graphics(plots[31:32])
```

### 33-34
```{r fig.width=10,fig.height=5}
knitr::include_graphics(plots[33:34])
```

### 35-36
```{r fig.width=10,fig.height=5}
knitr::include_graphics(plots[35:36])
```

### 37-38
```{r fig.width=10,fig.height=5}
knitr::include_graphics(plots[37:38])
```

### 39-40
```{r fig.width=10,fig.height=5}
knitr::include_graphics(plots[39:40])
```

### 41-42
```{r fig.width=10,fig.height=5}
knitr::include_graphics(plots[41:42])
```

### 43-44
```{r fig.width=10,fig.height=5}
knitr::include_graphics(plots[43:44])
```

### 45-46
```{r fig.width=10,fig.height=5}
knitr::include_graphics(plots[45:46])
```

### 47-48
```{r fig.width=10,fig.height=5}
knitr::include_graphics(plots[47:48])
```
