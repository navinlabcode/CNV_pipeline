...
packages <- c("tidyverse", "fs", "shiny",
              ...
              "flowCore","splus2R","locfit","dplyr","Metrics")
...
message(paste0(here(),"/",params$outdir))
message(paste(params$directory, "/fac_peak.R", sep = ""))
message(paste(params$directory, "/integer_cn.R", sep = ""))
# reading data
...
### UMAP. Hover mouse for more info. {data-height=300}
...
### FACs Ploidy Inference. Hover mouse for more info. {data-height=400}
...
### Ploidy interger Inference. Hover mouse for more info. {data-height=400}

```{r infering_ploidies2}
...
plots <- invisible(parallel::mclapply(seq_along(cell_names), function (x) {
  ...
  p <- ggplot(df %>% dplyr::filter(cell == cell_names[x])) +
